            ...
            <table id="table" class="table table-bordered table-striped display">
                <thead>
                     <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Wilaya darrivée" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Adresse" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Date darrivée" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Heure darrivée" disabled></th>
