        ...
        <div class="row clearfix">
            ...
            <table id="table" class="table table-bordered table-striped display">
                <thead>
                     <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Prix" disabled></th>
                          <th><input type="text" class="form-control" placeholder="Reste à payer" disabled></th>
                ...
                <tbody>
                    ...
                    {
                        $prixf=$ss['prix']*$_SESSION['marge']/100;
                        echo "<tr><td>".$ss['wilaya_d']."</td><td>".$ss['commune_d'].", ".$ss['rue_d']."</td><td>".$ss['DATEONLY']."</td><td>".$ss['TIMEONLY']."</td><td>".$ss['wilaya_a']."</td><td>".$ss['commune_a'].", ".$ss['rue_a']."</td><td>".$ss['DATEONLYA']."</td><td>".$ss['TIMEONLYA']."</td><td>".$ss['type_camion']."</td><td>".$ss['tonage']."</td><td>".$ss['prix']." DA</td><td>".$prixf." DA</td></tr>";
