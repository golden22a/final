...
<h5>Rue :</h5></td>
    ...
    <td> <?php echo $email; ?></td> 
                  <td>  
      <button class='btn btn-primary btn-xs' data-toggle='modal' data-target='#myModalNorm1'> modifier</button>
      </td>
  </tr>
             <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form-horizontal" method="post" id='emailchange'>
                 
                  <div class="form-group">
                     <div class="col-sm10">
                      <input type="text" class="form-control"
                          id="p1" placeholder="Nouveau email" name="mail" required/>
                      </div>
                      <input type="hidden" id="x" name="id_annonce" value>
                  </div>  <div class="form-group">
                     ...
                     <div class="col-sm-offset-5 col-sm-4">
                  <button type="button" class="btn btn-info btn-lg" onclick='fset1();'>Modifier</button>
                    </div>
                </form>
            ...
            <div class="modal-body">
                ...
                <form role="form-horizontal" method="post" id='phonechange'>
                  <div class="form-group">
                     ...
                     <div class="col-sm-offset-5 col-sm-4">
                  <button type="button" class="btn btn-info btn-lg" onclick='fset2();'>Modifier</button>
                    </div>
                </form>
    ...
    function fset(){
        ...
        /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/
            /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/    /* WTF IS THIS SHIT ?????????????????????????????????????????????????????????????????????*/
            function fset1(){
                $('#emailchange').submit();
